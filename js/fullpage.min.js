...
!(function (n, t) {
  ...
  var kt = function (n) {
    ...
    jt = function (n, t) {
      (this.parent = this.parent || null),
        ...
        (this.un = m(n, at) || null != p(ut, n)[0]),
        (this.ln = t === Tt().sectionSelector),
        (this.cn = F(n, ot) || F(n, Hn)),
        (this.index = function () {
  ...
  (jt.prototype.siblings = function () {
    ...
    (jt.prototype.vn = function () {
      return this.ln ? dn.F : dn.dn;
    });
  var Dt,
    Et = function (n) {
      kt.call(this, n);
    ...
    var e = (function (n, t) {
      var e = {
        afterRender: function () {
          return { section: $t(pn().I), pn: Qt(pn().I.activeSlide) };
        },
        onLeave: function () {
          return {
  ...
  function ue(n) {
    V(n), hn({ N: "horizontalNav" });
    var t = F(this, $n),
      e = p(et, F(this, $n))[0],
      i = Lt(pn().F, t).slides[A(F(this, "li"))];
  ...
  function ze(n) {
    Tt().verticalCentered &&
      ((!Tt().scrollOverflow && Ve.wn(n.item)) ||
        Ve.bn(n) ||
        m(n.item, rt) ||
        L(n.item, rt));
  }
  ...
  function Ie(n) {
    var t = n.item,
      e = n.yn.length,
      i = n.index();
    !pn().I && n.isVisible && (L(t, Kn), Qe(), (Fe = pn().I.item)),
  ...
  function Ne() {
    Tt().scrollOverflow && !Tt().scrollBar && (Ve.Sn(), Ve.Tn());
  }
  function Be() {
    q("keyup", Ve.Mn);
  }
  ...
  var He,
    ...
    Ve = {
      ...
      En: function () {
        r.activeElement === this.An && (this.An.blur(), (Ve.kn = !1));
      },
      Tn: function () {
        if (Tt().scrollOverflow && Ve.xn) {
          Ve.En();
          var n = Ve.Rn(pn().I.item);
          !n ||
            a ||
            l ||
            ((this.An = n),
        ...
        Tt().scrollOverflowMacStyle && !u && L(Kt, "fp-scroll-mac"),
          pn().dn.forEach(function (n) {
            if (
              ...
              n.un || (Ve.Pn(e), Ve.zn(e)), (n.un = !0);
            }
          });
      },
      zn: function (n) {
        Ve.Rn(n).addEventListener("scroll", Ve.Cn),
          n.addEventListener("wheel", Ve.Ln, { passive: !1 }),
          n.addEventListener("keydown", Ve.Dn, { passive: !1 });
      },
      Pn: function (n) {
        var t = document.createElement("div");
        (t.className = at), z(n, t), t.setAttribute("tabindex", "-1");
      },
      Fn: function (n) {
        var t = p(ut, n)[0];
      ...
      wn: function (n) {
        return Ve.Rn(n).scrollHeight > o.innerHeight;
      },
      In: function (n, t) {
        if (!dn.G) return !1;
        ...
        var i = c ? 1 : 0,
          ...
          u = r || a;
        return u || (this.jn = new Date().getTime()), u;
      },
      Nn: function () {
  ...
  function Xe() {
    ...
    (Ye = Je(dn.I)),
      ...
      (dn.P = t.length),
      (dn.C = i.reduce(function (n, t) {
        return n + t.slides.length;
      }, 0)),
      (dn.F = i),
      (dn.sn = e),
      (dn.slides = o),
      (dn.dn = dn.F.concat(dn.slides));
  }
  function Je(n) {
    if (!n) return null;
    var t = n ? n.item : null,
      e = n.ln ? dn.sn : dn.I.Wn;
    if (t) {
      var i = Lt(e, t);
  ...
  function oi(n) {
    ...
    y(p(ot, n.item), { width: o + "%" }),
      ...
      i.forEach(function (n) {
        y(n.item, { width: a + "%" }), Tt().verticalCentered && ze(n);
      });
  ...
  function ai() {
    return h(p(Tt().slideSelector, St())).length !== pn().C;
  }
  function ui(n) {
    var t = ai();
  ...
  function pi() {
    var n = Tt().css3
        ? H() + w()
        : rn(pn().F).item.offsetTop + rn(pn().F).item.offsetHeight,
      t = Ct(n);
    (f.test.top = -n + "px"),
      hn({ G: !1 }),
  ...
  function mi() {
    var n = Ct(rn(pn().F).item.offsetTop);
    hn({ G: !1 }),
  ...
  function Ti() {
    var n = pn().I.next();
    n || (!Tt().loopBottom && !Tt().continuousVertical) || (n = pn().F[0]),
      null != n
        ? je(n, null, !1)
        : St().scrollHeight < Kt.scrollHeight && vn.R(Dn);
  }
  function Mi() {
    var n = pn().I.prev();
    n || (!Tt().loopTop && !Tt().continuousVertical) || (n = rn(pn().F)),
      null != n && je(n, null, !0);
  }
  ...
  function ki(n) {
    if (fe().m[n]) {
      var t = "down" === n ? Ti : Mi;
      Tt().scrollOverflow && Ve.bn(pn().I)
        ? Ve.In(n, pn().I.item) && Ve.Nn() && t()
        : t();
    }
  }
  var ji,
    ...
    Ci =
      ...
      Di),
    Fi = {
      qn: "ontouchmove" in window ? "touchmove" : Ci ? Ci.move : null,
      Gn: "ontouchstart" in window ? "touchstart" : Ci ? Ci.down : null,
    };
  function Ii(n) {
    var t = F(n.target, $n) || pn().I.item,
      e = Ve.bn(pn().I);
    if (Ni(n)) {
      hn({ J: !0, Z: !1 }),
      ...
      var r = Math.abs(Ei - Pi) > (o.innerHeight / 100) * Tt().touchSensitivity,
        a = Math.abs(Ri - zi) > (b() / 100) * Tt().touchSensitivity,
        u = p(et, t).length && Math.abs(Ri - zi) > Math.abs(Ei - Pi),
        l = Ei > Pi ? "down" : "up";
      hn({ Y: u ? (Ri > zi ? "right" : "left") : l }),
        u
          ? !dn.W &&
            a &&
            (Ri > zi
            ...
            if (l || (!t && u)) {
              ...
              var c = (function (n) {
                  var t,
                    ...
                    i = [],
                    o = zt(
                      (dn.I && dn.I.activeSlide ? dn.I.activeSlide : dn.I)[e]()
                    );
                  do {
                    (i = io(o.item)).length &&
        ...
        (Oi = setTimeout(function () {
          !(function (n) {
            var t = n.shiftKey,
              ...
              o = Ve.In("up", pn().I.item),
              a = Ve.In("down", pn().I.item),
            ...
            if (
              ...
              switch ((hn({ N: "keydown" }), n.keyCode)) {
                case 38:
                case 33:
                  fe().k.up && o ? (dn.B ? vn.R(kn, { e: n }) : Mi()) : Ve.Tn();
                  break;
                case 32:
                  if (t && fe().k.up && !i && o) {
                    Mi();
    ...
    n
      ? (ao(!0),
        (function () {
          if (Fi.qn && (a || l)) {
            Tt().autoScrolling &&
              (Kt.removeEventListener(Fi.qn, Vi, { passive: !1 }),
              Kt.addEventListener(Fi.qn, Vi, { passive: !1 }));
            var n = Tt().touchWrapper;
            n.removeEventListener(Fi.Gn, Bi),
              n.removeEventListener(Fi.qn, Ii, { passive: !1 }),
              n.addEventListener(Fi.Gn, Bi),
              n.addEventListener(Fi.qn, Ii, { passive: !1 });
          }
        })())
      : (ao(!1),
        (function () {
          if (Fi.qn && (a || l)) {
            Tt().autoScrolling &&
              (Kt.removeEventListener(Fi.qn, Ii, { passive: !1 }),
              Kt.removeEventListener(Fi.qn, Vi, { passive: !1 }));
            var n = Tt().touchWrapper;
            n.removeEventListener(Fi.Gn, Bi),
              n.removeEventListener(Fi.qn, Ii, { passive: !1 });
  ...
  function Ao(n) {
    if (!m(St(), Un)) {
      hn({ V: !0, en: w(), Jn: b() });
      for (var t = pn().F, e = 0; e < t.length; ++e) {
        var i = t[e],
          r = p(et, i.item)[0];
        i.slides.length > 1 && _e(r, i.activeSlide.item);
      }
      Tt().scrollOverflow && Ve.Sn();
      var a = pn().I.index();
      dn.B || (a && go(a + 1)),
        hn({ V: !1 }),
        Y(Tt().afterResize) &&
  ...
  function Lo(n) {
    var t = n.target;
    F(t, Tt().menu + " [data-menuanchor]") && Do.call(t, n);
  }
  function Do(n) {
    hn({ N: "menu" }),
      !p(Tt().menu)[0] ||
  ...
  function Eo(n) {
    ...
    t && F(t, "#fp-nav a")
      ...
      : Q(t, ".fp-tooltip")
      ? pe.call(t)
      : (Q(t, ft) || null != F(t, ft)) && ue.call(t, n.e);
  }
  (f.reBuild = Ao),
    vn.D(Sn, function () {
  ...
  function No() {
    ...
    L(i, Gn),
      ...
      Jt(i),
      (t = qi((n = ko()).section)),
      (n.section && t && (void 0 === t || t.index() !== A(Fe))) ||
        !Y(Tt().afterLoad) ||
        Xt("afterLoad", {
          I: i,
          element: i,
    ...
    Xe(),
      ...
      (function () {
        y(ln(St(), "body"), { height: "100%", position: "relative" }),
          ...
          D(St(), Un),
          ii();
        for (var n = pn().sn, t = 0; t < n.length; t++) {
          var e = n[t],
            i = e.yn;
  ...
  return (
    ...
    vn.D(Sn, function () {
      K("scroll", Co),
        r.body.addEventListener("scroll", Co),
        vn.D(xn, function (n) {
    ...
    (f.destroy = function (n) {
      de(!1, "internal"),
        ...
        n &&
          ...
          y(Ot(pn().F), { height: "", "background-color": "", padding: "" }),
          ...
          Ot(pn().dn).forEach(function (n) {
            Tt().scrollOverflow && Ve.Fn(n),
              D(n, "fp-table active " + Gn),
              U(n, "data-fp-styles") &&
